...
const createItem = async (req, res) => {
    ...
    try {
        ...
        const insert = await req.dbClient.query(`INSERT INTO project_items(project_id, requirements, service_category, unit_cost, requirement_type)
...
const updateItem = async (req, res) => {
    ...
    try {
        ...
        const updated = await req.dbClient.query(`UPDATE project_items SET service_category=$1, unit_cost=$2, requirement_type=$3 WHERE project_id=$4 AND requirements=$5 RETURNING project_id, requirements, service_category, unit_cost, requirement_type`, [service_category, unit_cost, requirement_type, projectId, requirements]);
        if (delta !== 0) {
