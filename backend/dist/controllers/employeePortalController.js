...
exports.getPtoRequests = getPtoRequests;
exports.cancelPtoRequest = cancelPtoRequest;
...
exports.getPayslipDetails = getPayslipDetails;
exports.downloadPayslip = downloadPayslip;
exports.getYtdEarnings = getYtdEarnings;
exports.verifyPayslipToken = verifyPayslipToken;
exports.signPayslip = signPayslip;
...
exports.getEmployeeDirectory = getEmployeeDirectory;
...
async function getDashboard(req, res) {
    ...
    try {
        ...
        await (0, employeeAuditLog_1.logEmployeeActionFromRequest)(employeeId, employeeAuditLog_1.EmployeeAuditActions.DASHBOARD_VIEWED, req, { resourceType: 'dashboard', resourceId: employeeId });
    ...
    `;
        ...
        // Log the error
        await (0, employeeAuditLog_1.logEmployeeActionFromRequest)(employeeId, employeeAuditLog_1.EmployeeAuditActions.DASHBOARD_VIEWED, req, {
...
async function getStats(req, res) {
    ...
    `;
        ...
        // Log the error
        await (0, employeeAuditLog_1.logEmployeeActionFromRequest)(employeeId, employeeAuditLog_1.EmployeeAuditActions.STATS_VIEWED, req, {
            resourceType: 'stats',
            resourceId: employeeId,
            status: 'failure',
            errorMessage: error instanceof Error ? error.message : 'Unknown error'
...
async function updateProfile(req, res) {
    ...
    `;
        ...
        await (0, employeeAuditLog_1.logEmployeeActionFromRequest)(employeeId, employeeAuditLog_1.EmployeeAuditActions.PROFILE_UPDATED, req, {
 ...
 */
async function getPtoBalance(req, res) {
    const employeeId = parseInt(req.params.employeeId);
    try {
    ...
    `;
        ...
        // Log the error
        await (0, employeeAuditLog_1.logEmployeeActionFromRequest)(employeeId, employeeAuditLog_1.EmployeeAuditActions.PTO_BALANCE_VIEWED, req, {
 ...
 */
async function createPtoRequest(req, res) {
    const employeeId = parseInt(req.params.employeeId);
    ...
    `;
        ...
        if (managerDetailsResult.rows.length > 0) {
            ...
            const { sendEmail } = await Promise.resolve().then(() => __importStar(require('../utils/emailService')));
 ...
 */
async function getPtoRequests(req, res) {
    const employeeId = parseInt(req.params.employeeId);
    ...
    `;
        ...
        // Log the error
        await (0, employeeAuditLog_1.logEmployeeActionFromRequest)(employeeId, employeeAuditLog_1.EmployeeAuditActions.PTO_HISTORY_VIEWED, req, {
 ...
 */
async function cancelPtoRequest(req, res) {
    const employeeId = parseInt(req.params.employeeId);
...
async function getTimeEntries(req, res) {
    ...
    `;
        ...
        await (0, employeeAuditLog_1.logEmployeeActionFromRequest)(employeeId, employeeAuditLog_1.EmployeeAuditActions.TIME_REPORT_VIEWED, req, {
...
async function getTimeReport(req, res) {
    ...
    try {
        // Log the report view
        await (0, employeeAuditLog_1.logEmployeeActionFromRequest)(employeeId, employeeAuditLog_1.EmployeeAuditActions.TIME_REPORT_VIEWED, req, { resourceType: 'time_report', resourceId: employeeId });
...
async function getPayslips(req, res) {
    ...
    `;
        ...
        await (0, employeeAuditLog_1.logEmployeeActionFromRequest)(employeeId, employeeAuditLog_1.EmployeeAuditActions.PAYSLIP_VIEWED, req, {
...
async function downloadPayslip(req, res) {
    ...
    `;
        ...
        const { generatePayslipPdf } = await Promise.resolve().then(() => __importStar(require('../utils/payslipPdfGenerator')));
        await generatePayslipPdf(payslipResult.rows[0], signaturesResult.rows, res);
    }
    catch (error) {
        console.error('Error downloading payslip:', error);
        await (0, employeeAuditLog_1.logEmployeeActionFromRequest)(employeeId, employeeAuditLog_1.EmployeeAuditActions.PAYSLIP_DOWNLOADED, req, {
            resourceType: 'payslip',
            resourceId: payslipId,
            status: 'failure',
            errorMessage: error instanceof Error ? error.message : 'Unknown error'
 ...
 */
async function getYtdEarnings(req, res) {
    const employeeId = parseInt(req.params.employeeId);
    const year = req.query.year ? parseInt(req.query.year) : new Date().getFullYear();
    try {
        // Log the YTD view
        await (0, employeeAuditLog_1.logEmployeeActionFromRequest)(employeeId, employeeAuditLog_1.EmployeeAuditActions.YTD_EARNINGS_VIEWED, req, { resourceType: 'ytd_earnings', resourceId: employeeId });
        // Get summary totals
        const summaryQuery = `
      SELECT 
    ...
    `;
        ...
        await (0, employeeAuditLog_1.logEmployeeActionFromRequest)(employeeId, employeeAuditLog_1.EmployeeAuditActions.YTD_EARNINGS_VIEWED, req, {
 ...
 */
async function verifyPayslipToken(req, res) {
    const { token } = req.body;
    if (!token) {
        return res.status(400).json({ error: 'missing_token', message: 'Token is required' });
    }
    try {
        const { validatePayslipToken } = await Promise.resolve().then(() => __importStar(require('../utils/payslipTokens')));
 ...
 */
async function signPayslip(req, res) {
    const employeeId = parseInt(req.params.employeeId);
    const payslipId = parseInt(req.params.payslipId);
    ...
    try {
        const { validatePayslipToken, markTokenAsUsed } = await Promise.resolve().then(() => __importStar(require('../utils/payslipTokens')));
        // Validate token
        const validation = await validatePayslipToken(token);
        if (!validation.valid) {
            return res.status(400).json({
    ...
    `;
        ...
        // Log the signature
        await (0, employeeAuditLog_1.logEmployeeActionFromRequest)(employeeId, employeeAuditLog_1.EmployeeAuditActions.PAYSLIP_SIGNED, req, {
            resourceType: 'payslip',
            resourceId: payslipId,
            newValue: { signatureId: signatureResult.rows[0].signature_id }
        });
        // Send confirmation email
        const { sendPayslipSignedConfirmation } = await Promise.resolve().then(() => __importStar(require('../utils/emailService')));
...
async function getDocuments(req, res) {
    ...
    `;
        ...
        await (0, employeeAuditLog_1.logEmployeeActionFromRequest)(employeeId, employeeAuditLog_1.EmployeeAuditActions.DOCUMENT_VIEWED, req, {
...
async function uploadDocument(req, res) {
    ...
    if (!documentType || !validTypes.includes(documentType)) {
        ...
        const { deleteFile } = await Promise.resolve().then(() => __importStar(require('../utils/fileValidation')));
    ...
    try {
        const { validateUploadedFile, ensureUploadDirectory, generateUniqueFilename, sanitizeFilename, deleteFile } = await Promise.resolve().then(() => __importStar(require('../utils/fileValidation')));
        const { notifyDocumentUploaded } = await Promise.resolve().then(() => __importStar(require('../utils/notificationService')));
...
async function getNotifications(req, res) {
    ...
    try {
        const { getNotifications: getNotificationsService } = await Promise.resolve().then(() => __importStar(require('../utils/notificationService')));
...
async function markNotificationRead(req, res) {
    ...
    try {
        const { markNotificationAsRead } = await Promise.resolve().then(() => __importStar(require('../utils/notificationService')));
...
async function markAllNotificationsRead(req, res) {
    const employeeId = parseInt(req.params.employeeId);
    try {
        const { markAllNotificationsAsRead } = await Promise.resolve().then(() => __importStar(require('../utils/notificationService')));
...
async function archiveNotification(req, res) {
    ...
    const notificationId = parseInt(req.params.notificationId);
    try {
        const { archiveNotification: archiveNotificationService } = await Promise.resolve().then(() => __importStar(require('../utils/notificationService')));
...
async function getUnreadNotificationCount(req, res) {
    const employeeId = parseInt(req.params.employeeId);
    try {
        const { getUnreadCount } = await Promise.resolve().then(() => __importStar(require('../utils/notificationService')));
...
async function updateEmailPreferences(req, res) {
    ...
    try {
        ...
        if (pto_notifications === undefined &&
...
async function getEmployeeDirectory(req, res) {
    ...
    `;
        ...
        if (req.user) {
            await (0, employeeAuditLog_1.logEmployeeActionFromRequest)(req.user.id || 0, employeeAuditLog_1.EmployeeAuditActions.DIRECTORY_VIEWED, req, {
