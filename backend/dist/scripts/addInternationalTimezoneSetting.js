...
async function addInternationalTimezoneSetting() {
    try {
        ...
        const checkResult = await db_1.pool.query('SELECT * FROM application_settings WHERE setting_key = $1', ['international_timezone']);
        if (checkResult.rows.length > 0) {
            ...
            // Insert the setting
            await db_1.pool.query(`INSERT INTO application_settings (setting_key, setting_value, description, updated_by)
         VALUES ($1, $2, $3, $4)`, [
