...
async function fixRailwayPortalErrors() {
    ...
    try {
        ...
        const settingCheck = await client.query('SELECT * FROM application_settings WHERE setting_key = $1', ['international_timezone']);
...
exports.default = fixRailwayPortalErrors;
